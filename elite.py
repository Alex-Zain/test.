...
def menu_log():
    ...
    banner()
    var_menu()
    pmu = input('%s[%s•%s] %s choose : '%(O,P,O,P))
    if pmu in ['']:
...
def menu():
    ...
    print('\x1b[1;37m[\x1b[1;32m4\x1b[1;37m] Retrieve Target Data')
    print('\x1b[1;37m[\x1b[1;32m5\x1b[1;37m] Taking Number of Friends ')
    print('\x1b[1;37m[\x1b[1;32m6\x1b[1;37m] Check Crack Results')
    print('\x1b[1;37m[\x1b[1;32m7\x1b[1;37m] Check Crack Result Options ')
    print('\x1b[1;37m[\x1b[1;32m8\x1b[1;37m] User Agent')
    print('\x1b[1;37m[\x1b[1;32m9\x1b[1;37m] Log Out')
    print('\033[1;97m-------------------------------------------------')
    pm = input('%s[%s•%s] %s choose : '%(O,P,O,P))
    if pm in ['']:
        jalan('%s[%s!%s] %s Correct Content'%(M,P,M,P))
        menu()
        ...
        while True:
            ...
            if f=="":
                ...
                try:
                    ...
                    print(("   %s"%e))
                    continue
                print(' \x1b[1;37mContoh : sayang,bismillah,123456')
                self.pwlist()
                break
